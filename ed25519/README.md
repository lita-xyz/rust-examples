...
This is a simple program that verifies an Ed25519 signature in Valida.
...
```
valida> valida run ./target/valida-unknown-baremetal-gnu/release/ed25519 log
```

The `run` command runs the program and verifies the Ed25519 signature and prints the result to the console and the file `log` in the current directory.
